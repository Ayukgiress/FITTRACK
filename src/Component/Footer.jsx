        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div className="flex flex-col items-start lg:items-end">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.linkedin.com/in/ayuk-giress-077734294" className="text-gray-400 hover:text-white transition-colors duration-200">
              ...
              <a href="https://x.com/AyukGiress" className="text-gray-400 hover:text-white transition-colors duration-200">
              ...
              <a href="https://github.com/Ayukgiress" className="text-gray-400 hover:text-white transition-colors duration-200">
