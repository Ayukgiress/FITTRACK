  ...
  return (
    <div className="text-white 3xl:h-[60rem] bg-black 3xl:mt-40 flex flex-col items-center py-10 px-4 3xl:m-4 lg:h-[30rem] 2xl:h-[45rem] xl:mt-32 xl:h-[45rem]">
      ...
      <div className="flex flex-wrap justify-center gap-4 md:gap-6 lg:gap-2 2xl:gap-[2rem]">
        <div className="flex flex-col items-center justify-center w-full sm:w-84 sm:h-[35rem] lg:w-[15rem] xl:w-[23rem] 2xl:w-[34rem] lg:h-[28rem] xl:h-[30rem]  3xl:w-[47rem] 3xl:h-[45rem] gap-4 m-4 bg-fitness p-4 lg:p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
          <img
        ...
        <div className="flex flex-col items-center sm:w-84 sm:h-[35rem] justify-center w-full  lg:w-[15rem] xl:w-[23rem] 2xl:w-[34rem] lg:h-[28rem] xl:h-[30rem] gap-4 m-4 bg-fitness  3xl:w-[47rem] 3xl:h-[45rem] p-4 lg:p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
          <img
            src={fitnessGoalsImg}
