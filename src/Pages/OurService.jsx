...
const OurService = () => {
  return (
    <div className="bg-customGradient text-white flex items-center justify-around flex-col">
      <h1 className="text-2xl mb-8">Our Services</h1>

      <div className="flex flex-wrap items-center justify-around gap-20 m-5">
  <div className="flex w-80 h-80">
    <div className="flex flex-col justify-between p-4 w-3/5 h-full" style={{background: "linear-gradient(to right, #4d210e, #191919)"}}>
    ...
    <img src={buildingMusclesImage} alt="Building Muscles" className="w-2/5 h-full object-cover" style={{backgroundColor: "#191919"}} />
  </div>
  <div className="flex w-80 h-80">
    <div className="flex flex-col justify-between p-4 w-3/5 h-full" style={{background: "linear-gradient(to right, #4d210e, #191919)"}}>
    ...
    <img src={trainingAtHomeImage} alt="Training at Home" className="w-2/5 h-full object-cover" style={{backgroundColor: "#191919"}} />
  </div>
  <div className="flex w-80 h-80">
    <div className="flex flex-col justify-between p-4 w-3/5 h-full" style={{background: "linear-gradient(to right, #4d210e, #191919)"}}>
    ...
    <img src={gymPlanImage} alt="Gym Plan" className="w-2/5 h-full object-cover" style={{backgroundColor: "#191919"}} />
  </div>
</div>
