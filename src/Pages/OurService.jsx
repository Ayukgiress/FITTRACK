  ...
  return (
    <div className="bg-customGradient 2xl:h-[28rem] 3xl:m-8 3xl:h-[50rem] xl:h-[40rem] text-white flex flex-col items-center justify-center p-4 3xl:mt-80">
      ...
      <div className="flex flex-col sm:flex-row flex-wrap 2xl:gap-[3rem] items-center justify-center gap-6 md:gap-12 lg:gap-10">
        {/* Service Item 1 */}
        <div className="service w-full sm:w-82 lg:w-[32rem] flex flex-col sm:flex-row mb-4 xl:w-[23rem] 2xl:w-[35rem] 3xl:w-[50rem] 3xl:h-[47rem]">
          <div
          ...
          >
            ...
            <h5 className="text-sm lg:text-sm 3xl:text-3xl 2xl:text-2xl leading-snug lg:leading-normal sm:text-4xl">
        ...
        <div className="service w-full sm:w-82 lg:w-[32rem] flex flex-col sm:flex-row mb-4 xl:w-[23rem] 2xl:w-[35rem] 3xl:w-[50rem] 3xl:h-[47rem]">
          ...
          >
            ...
            <h3 className="text-sm lg:text-sm 3xl:text-3xl 2xl:text-2xl leading-snug lg:leading-normal sm:text-4xl">
