    ...
    <div className='bg-customGradient h-96 w-full flex items-center justify-around g-2'>
       <div className='flex items-center justify-center flex-col text-white gap-6'>
        <h1 className='text-white text-3xl gap-2'>
          ...
          Our expert coaches and personalized programs are designed to help <br />
          you achieve  your goals and exceed your expectations. Ready to make a change?"
          </h4>
       <Link to="/login">
       <button className='w-96 h-9 rounded-md bg-red-700'>Start Your Journey</button>
       ...
       <div>
       <img src="src/assets/images/pexels-panther-1547248-Photoroom.png" alt="img" className='bg-transparent border-b-2 border-red-600 h-80 rounded-full w-5/6' />       </div>
