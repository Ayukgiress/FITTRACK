...
const Home = () => {
  return (
    <>
<div className="bg-customGradient h-[34rem] flex items-center justify-around px-4 md:px-10">
  <div className="flex items-center justify-center flex-col text-white gap-6 text-center md:text-left">
    <h1 className="text-white text-4xl md:text-5xl lg:text-6xl gap-2">
      Archive Your <br />
      Fitness With <br />
    ...
    <Link to="/login">
      <button className="w-80 max-w-xs h-12 rounded-md bg-red-700 text-white">
        Start Your Journey
      </button>
    </Link>
  </div>
  ...
  <div className="hidden md:flex justify-center">
    <img
      src={myImage}
      alt="img"
      className="bg-transparent border-b-2 border-red-600 h-96 rounded-full w-96 md:w-5/6 lg:w-2/3"
    />
  </div>
</div>
