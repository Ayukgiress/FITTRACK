...
const DistanceChart = () => {      
  ...
  useEffect(() => {
    // Only process data if not loading and we have data
    if (!loading && weeklyRunningDistance && weeklyRunningDistance.length > 0) {
      const aggregatedData = Object.keys(trafficData).reduce((acc, month) => {
        acc[month] = 0;
        return acc;
      }, {});
      ...
      // Round the aggregated data to 2 decimal places
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white rounded-lg shadow p-6 flex flex-col items-center justify-center">
      ...
      <div className="flex items-center justify-center mb-6 w-full sm:w-[450px] md:w-[300px] lg:w-[300px] xl:w-[300px] 3xl:w-[800px] 3xl:h-[700px] 2xl:w-[35rem] 2xl:h-[17rem]">
        {loading ? (
